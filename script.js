...
function confirmOrder() {
    ...
    const timer = setInterval(() => {
        ...
        if (countdown <= 0) {
            ...
            document.body.innerHTML = '<div style="text-align: center; padding: 50px; color: #fff;"><h1>Grazie per aver utilizzato la nostra app!</h1><p>Puoi chiudere questa finestra.</p></div>';
        }
    }, 1000);
}
